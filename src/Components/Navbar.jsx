  ...
  return (
    <div className="navbar z-10 h-20 w-full flex items-center justify-between gap-5 md:px-20 bg-zinc-800 fixed top-0">
        ...
        <div className="middle flex items-center justify-center gap-2 text-white">
            ...
            <button className='border-2 border-zinc-500 py-2 px-8 text-zinc-400 rounded-md active:transform active:translate-y-1 duration-300 transition-all hover:bg-zinc-700'>Search</button>
        </div>
